...
export const DATA = {
  ...
  contact: {
    ...
    social: {
      GitHub: {
        name: "GitHub",
        url: "https://github.com/KeiberLLB",
        icon: Icons.github,
      ...
      LinkedIn: {
        name: "LinkedIn",
        url: "https://www.linkedin.com/in/keiber-leandro-l%C3%A1zaro-bastos-8008612a4/",
        icon: Icons.linkedin,
      ...
      email: {
        name: "Send Email",
        url: "mailto:leandro1991.9@gmail.com",
        icon: Icons.email,
  ...
  work: [
    {
      ...
      badges: [],
      location: "On-site",
      title: "Software Developer - Backend Junior",
      logoUrl: "/riwi.webp",
      start: "Sep 2023",
      end: "Nov 2024",
      description:
  ...
  education: [
    {
      school: "Riwi Be a Coder",
      href: "https://riwi.io/",
      degree: "Java, Spring Boot, MicroService, API Rest",
      logoUrl: "/riwi.webp",
      start: "Sep 2023",
      end: "Nov 2024",
    },
